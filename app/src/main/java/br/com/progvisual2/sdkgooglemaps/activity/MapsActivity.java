...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        satelite = findViewById(R.id.btsatelite);
        ...
        satelite.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(MapsActivity.this, MapsSatelite.class);
                startActivity(i);
    ...
    public void onBackPressed() {
        ...
        Intent i = new Intent(MapsActivity.this, br.com.progvisual2.sdkgooglemaps.activity.Menu.class);
        startActivity(i);
    }
}
